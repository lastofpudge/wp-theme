...
class PLLWC_Strings
{
    ...
    public function __construct()
    {
        ...
        add_filter('woocommerce_shipping_zone_shipping_methods', array( $this, 'translate_shipping_methods' ));
    ...
    protected static function get_options()
    {
        return array(
            ...
            'email_header_image'                          => array( 'name' => __('Email header image', 'polylang-wc') ),
    ...
    public function sanitize_strings($translation, $name, $context)
    {
        ...
        switch ($name) {
            ...
            case __('Currency position', 'polylang-wc'):
                $translation = in_array($translation, array( 'left', 'right', 'left_space', 'right_space' )) ?: get_option('woocommerce_currency_pos', 'left');
                break;
