...
class PLLWC_Xdata
{
    ...
    {
        add_filter('pll_get_xdata', [$this, 'get_xdata']);
        add_action('pll_set_xdata', [$this, 'set_xdata']);
        add_filter('pll_xdata_session_manager', [$this, 'get_session_manager']);

        if (3 === PLL()->options['force_lang']) {
            add_filter('woocommerce_set_cookie_options', [$this, 'set_cookie_options'], 10, 2); // Since WC 6.7.
        }
    }
