...
class PLLWC_Wizard
{
    public const PLUGIN_FILTER = array( 'woocommerce', 'polylang', 'polylang-pro', 'polylang-wc' );
    ...
    public function get_translation_updates()
    {
        ...
        remove_filter('site_transient_update_plugins', array( $this, 'update_last_checked' ));
