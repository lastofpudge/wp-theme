...
class PLLWC_Admin_Orders_Legacy extends PLLWC_Admin_Orders
{
    ...
    public function custom_columns()
    {
        ...
        foreach ($translated_order_types as $translated_order_type) {
            ...
            remove_filter('manage_edit-'.$translated_order_type.'_columns', [$class, 'add_post_column'], 100);
            remove_action('manage_'.$translated_order_type.'_posts_custom_column', [$class, 'post_column']);

            add_filter('manage_edit-'.$translated_order_type.'_columns', [$this, 'add_order_column'], 100);
            add_action('manage_'.$translated_order_type.'_posts_custom_column', [$this, 'order_column'], 10, 2);
        }
    }
