...
class PLLWC_Product_Bundles
{
    ...
    public function __construct()
    {
        ...
        add_filter('pll_post_metas_to_export', array( $this, 'get_metas_to_translate' ));
    ...
    {
        return array_merge($metas, array( '_wc_pb_bundle_sells_title' => 1 ));
    }
