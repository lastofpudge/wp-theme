...
class PLLWC_REST_Order extends PLL_REST_Translated_Object
{
    ...
    {
        add_filter('woocommerce_rest_shop_order_object_query', [$this, 'add_language_query_arg_in_rest'], 10, 2);

        parent::__construct($rest_api, ['shop_order' => ['filters' => false, 'translations' => false]]);
