...
class PLLWC_Links
{
    ...
    public function __construct()
    {
        ...
        if (PLL()->options['force_lang'] > 1) {
            ...
            add_filter('woocommerce_get_item_downloads', array( $this, 'filter_download_urls' ));
            add_filter('woocommerce_product_file_download_path', array( $this, 'filter_download_url' ));
        }
    }
