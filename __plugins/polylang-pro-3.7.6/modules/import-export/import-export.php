...
class PLL_Import_Export
{
    ...
    public const TERM_META = 'termmeta';

    public const POST_TITLE = 'post_title';
    public const POST_CONTENT = 'post_content';
    public const POST_EXCERPT = 'post_excerpt';
    public const POST_META = 'postmeta';

    public const STRINGS_TRANSLATIONS = 'strings-translations';
