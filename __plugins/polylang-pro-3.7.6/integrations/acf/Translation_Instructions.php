...
{
    public const TAB_NAME = 'pll-instructions';
    public const SETTING_KEY = 'pll_display_field_instructions';
    ...
    {
        add_filter('acf/field_group/additional_group_settings_tabs', [$this, 'add_field_instructions_setting_tab']);
        add_action('acf/field_group/render_group_settings_tab/'.self::TAB_NAME, [$this, 'add_field_instructions_setting']);
        add_filter('acf/pre_render_fields', [static::class, 'append_translation_instructions']);
    }
    ...
    {
        add_filter('acf/prepare_field', [static::class, 'get_field_instructions']);
