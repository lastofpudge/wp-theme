...
class PLL_Pro
{
    ...
    public function init(&$polylang)
    {
        ...
        add_action('pll_upgrade', [new Upgrade($options), 'upgrade']);
        ...
        if ($polylang instanceof PLL_Admin_Base) {
            ...
            add_filter('http_request_args', [$this, 'http_request_args'], 10, 2); // phpcs:ignore WordPressVIPMinimum.Hooks.RestrictedHooks.http_request_args
        ...
        add_filter('wp_plugin_dependencies_slug', [$this, 'convert_plugin_dependency']);
    ...
    public function http_request_args($args, $url)
    {
        if (false !== strpos($url, '//api.wordpress.org/plugins/update-check/')) {
            ...
            if (empty($plugins['plugins']['polylang/polylang.php'])) {
                $plugins['plugins']['polylang/polylang.php'] = ['Version' => POLYLANG_VERSION];
