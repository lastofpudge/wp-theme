...
abstract class PLL_Translation_Metas
{
     ...
     * @var string   $meta_key       The name of the meta.
     * @var string[] $meta_sub_keys  The meta sub-fields to translate.
     * @var int      $value_position The position of the value in case of multiple values.
     * @var string   $encoding       Encoding format of the meta value.
     *               }
     *
    ...
    public function translate($src_object_id, $tr_object_id, PLL_Language $target_language, $copy)
    {
         ...
         */
        if ($copy) {
            add_filter("pll_copy_{$this->get_type()}_metas", [$this, 'remove_metas_to_translate']);
            $this->sync_metas->copy($src_object_id, $tr_object_id, $target_language->slug, false);
            remove_filter("pll_copy_{$this->get_type()}_metas", [$this, 'remove_metas_to_translate']);
        }
     ...
     *
     * @var string   $meta_key       The name of the meta.
     * @var string[] $meta_sub_keys  The meta subfields to translate.
     * @var int      $value_position The position of the value in case of multiple values.
     * @var string   $encoding       Encoding format of the meta value.
     * @var string   $context_id     ID key from entry context, useful to translate back.
     *               }
     *
     ...
     *
     * @var array  $meta_sub_keys  The meta sub keys.
     * @var int    $value_position The value position.
     * @var string $encoding       Meta encoding.
     * @var string $context_id     ID key from entry context, useful to translate back.
     *             }
     *
