...
class PLL_Export_Data_From_Posts
{
     ...
     *
     * @var bool $include_translated_items Tells if items that are already translated in the target languages must
     ...
     * @return void
     */
    public function send_to_export(PLL_Export_Container $container, array $posts, PLL_Language $target_language, array $args = [])
    {
     ...
     * @return WP_Post[]
     */
    protected function get_posts_to_export(array $posts, PLL_Language $lang, array $args = []): array
    {
     ...
     * @return WP_Term[]
     */
    protected function get_terms_to_export(array $posts, PLL_Language $lang, array $args = []): array
    {
        $include_translated_items = !empty($args['include_translated_items']);
