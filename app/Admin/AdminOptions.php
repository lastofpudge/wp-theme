...
class AdminOptions
{
    ...
    public function registerScripts()
    {
        ...
        wp_enqueue_script(
            'wp_main',
            get_template_directory_uri() . '/assets/dist/js/wp_main.js',
            [],
            filemtime(get_theme_file_path('/assets/dist/js/wp_main.js'))
        );
        ...
        wp_enqueue_script(
            ...
            [],
            filemtime(get_theme_file_path('/assets/dist/js/bundle.js'))
        );
