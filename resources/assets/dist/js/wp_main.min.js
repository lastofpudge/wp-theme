...
/***/ "./resources/assets/src/scripts/contactForm.js":
/*!*****************************************************!*\
  !*** ./resources/assets/src/scripts/contactForm.js ***!
  \*****************************************************/
...
function initContactForm() {
  ...
  $(document).on("submit", ".js-contact-form", function (event) {
    ...
    var formData = buildFormData(form);
    $.ajax({
      type: "POST",
      url: data.ajax_url,
      processData: false,
...
function handleSuccess(response, Toast) {
  if (response.type === "success") {
    ...
    var _response$sended, _response$sended$erro;
    var errorMessage = ((_response$sended = response.sended) === null || _response$sended === void 0 ? void 0 : (_response$sended$erro = _response$sended.errors) === null || _response$sended$erro === void 0 ? void 0 : _response$sended$erro.wp_mail_failed[0]) || response.message;
    Toast.fire({
      icon: "error",
      iconColor: "red",
      title: errorMessage
...
/***/ "./resources/assets/src/scripts/wp_main.js":
/*!*************************************************!*\
  !*** ./resources/assets/src/scripts/wp_main.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _contactForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./contactForm */ "./resources/assets/src/scripts/contactForm.js");
window.$ = window.jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");

$(function () {
  (0,_contactForm__WEBPACK_IMPORTED_MODULE_0__.initContactForm)();
});
...
/******/ 	__webpack_require__.O(undefined, ["css/bundle.min"], () => (__webpack_require__("./resources/assets/src/scripts/wp_main.js")))
